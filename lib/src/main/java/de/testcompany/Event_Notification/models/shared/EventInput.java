...
public class EventInput {
    ...
    public EventInput withEntityAt(OffsetDateTime entityAt) {
    ...
    public EventInput withEntityId(String entityId) {
    ...
    public EventInput withEventId(String eventId) {
    ...
    public EventInput withEventStatus(String eventStatus) {
    ...
    public EventInput withEventType(EventTypeSingle eventType) {
        this.eventType = eventType;
        return this;
    }
    
    public EventInput(@JsonProperty("eventId") String eventId, @JsonProperty("eventStatus") String eventStatus, @JsonProperty("eventType") EventTypeSingle eventType) {
        this.eventId = eventId;
        this.eventStatus = eventStatus;
        this.eventType = eventType;
  }
